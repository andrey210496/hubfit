...
Invoke-SCP ".\patch_port_9000_explicit.py" "${vpsAddress}:/root/patch_port_9000_explicit.py"

Write-Host "Executing patch script on VPS..." -ForegroundColor Cyan
Invoke-SSH $vpsAddress "python3 /root/patch_port_9000_explicit.py"
