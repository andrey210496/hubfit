...
Invoke-SCP ".\fix_syntax.py" "${vpsAddress}:/root/fix_syntax.py"

Write-Host "Executing fix script on VPS..." -ForegroundColor Cyan
Invoke-SSH $vpsAddress "python3 /root/fix_syntax.py"
