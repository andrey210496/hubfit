...
Invoke-SCP ".\patch_port_8000_safe.py" "${vpsAddress}:/root/patch_port_8000_safe.py"

Write-Host "Executing patch script on VPS..." -ForegroundColor Cyan
Invoke-SSH $vpsAddress "python3 /root/patch_port_8000_safe.py"
